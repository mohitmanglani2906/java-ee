...
public class CheckSignUp implements Filter 
{
   ...
   // @Autowired 
    //UserExits ue; // A filter is instantiated by the servlet container so @Autowired is useless
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException 
    {
        ...
        System.out.println(fname + " " + lname +  " " + email + " " + phone_no + " " + address + " " + gender + " " + password + " " + repassword);
        ...
        else if(ue.userExitsOrNot(email))
        {

...
<p>The Spring Professional certification exam is designed to test and validate <br /> your understanding of and familiarity with Spring. <a href="https://pivotal.io/training/certification/spring-professional-certification">Learn More</a></p>
</div>
</section>
...
<p>Connect the Enterprise to the Internet of Anything&mdash;mobile devices, sensors, wearables, automobiles, and more. Spring Cloud Data Flow provides a unified service for creating composable data microservices that address streaming and ETL-based data processing patterns. </p>
</div>
</div>
</div>
</div>
...
<tr>
<td><div class="dash">-</div></td>
<td>Developer productivity tools such as LiveReload and Auto Restart</td>
</tr>
<tr>
<td><div class="dash">-</div></td>
...
<p><strong>API Gateway</strong><br />Single entry point for API consumers (e.g., browsers, devices, other APIs) </p>
</div>
</div>
<div class="column">
<div class="inner">
...
<tr>
<td><div class="dash">-</div></td>
<td>Supported platforms: Cloud Foundry, Kubernetes, Apache YARN, and Apache Mesos</td>
</tr>
</TBODY></table>
<br />
<hr />
